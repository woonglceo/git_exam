...
<body>
	<form name="writeForm" id="writeForm" method="post" action="/mvcMember/member/write.do">
		<table border="1" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="중복체크" name="checkIdBtn">
					<div id="idDiv"></div>
					<input type="hidden" id="isIdChecked" value="false" readonly>
				</td>	
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button" onclick="checkWrite()" id="writeBtn" value="회원가입">
	...
	// 아이디 중복체크
	//$('#checkIdBtn').click(function(){});  // 체크박스 등 여러가지가 있으면 class를 써야한다. 지금은 하나니까 id
	$('input[name="checkIdBtn"]').click(function(){
		...
		if (sId == ''){
			...
			window.open("/mvcMember/member/checkId.do?id="+sId,"checkId","width=400","height=100")
		}
	...
	$('#writeBtn').click(function(){
		...
		else if($('#isIdChecked').val() == 'false') {$('#idDiv').text('아이디 중복체크를 해주세요');}
